    ...
    try {
      ...
      setServerError(
        info.mode === 'Network Point of Sale Terminal'
          ? `No se puede conectar al servidor en ${info.serverIp || '(sin IP configurada)'}. Revisá la IP del servidor en Configuración.`
          : 'El servidor local no responde. Usá la ventana de la app de Electron con `npm run dev`.'
      );
    }
    return info;
  };
